...
export const DISTRICTS = {
  1: { color:'#0f487c', region:'Panhandle',
       officer:{ name:'[Officer Name]', school:'[Officer School]', email:'vpdist1@fldeca.org', link:'#district-1' } },
  2: { color:'#61a1d7', region:'Northeast Florida',
       officer:{ name:'[Officer Name]', school:'[Officer School]', email:'vpdist2@fldeca.org', link:'#district-2' } },
  3: { color:'#2a71b9', region:'North Central Florida',
       officer:{ name:'[Officer Name]', school:'[Officer School]', email:'vpdist3@fldeca.org', link:'#district-3' } },
  4: { color:'#4c4c4e', region:'Central Florida / Orlando',
       officer:{ name:'[Officer Name]', school:'[Officer School]', email:'vpdist4@fldeca.org', link:'#district-4' } },
  5: { color:'#0f487c', region:'Polk County',
       officer:{ name:'[Officer Name]', school:'[Officer School]', email:'vpdist5@fldeca.org', link:'#district-5' } },
  6: { color:'#2a71b9', region:'West Coast / Tampa Bay',
       officer:{ name:'[Officer Name]', school:'[Officer School]', email:'vpdist6@fldeca.org', link:'#district-6' } },
  7: { color:'#61a1d7', region:'Southwest Florida',
       officer:{ name:'[Officer Name]', school:'[Officer School]', email:'vpdist7@fldeca.org', link:'#district-7' } },
  8: { color:'#000000', region:'Treasure Coast / Palm Beach',
       officer:{ name:'[Officer Name]', school:'[Officer School]', email:'vpdist8@fldeca.org', link:'#district-8' } },
  9: { color:'#4c4c4e', region:'Broward County',
       officer:{ name:'[Officer Name]', school:'[Officer School]', email:'vpdist9@fldeca.org', link:'#district-9' } },
  10:{ color:'#0f487c', region:'Miami-Dade',
       officer:{ name:'[Officer Name]', school:'[Officer School]', email:'vpdist10@fldeca.org', link:'#district-10' } }
};
...
export const SCHOOLS_RAW = [
  ...
  ["Andrew Jackson High School",1,"Jacksonville"],
  ...
  ["New Smyrna Beach High School",3,"New Smyrna Beach"],
  ...
  ["Williston Middle High School",3,"Williston"],
  ...
  ["Seffner Christian Academy",6,"Seffner"],
  ...
  ["Atlantic Community High School",8,"Delray Beach"],
  ["Boca Prep International School",8,"Boca Raton"],
  ...
  ["Florida Preparatory Academy",8,"Melbourne FL"],
  ...
  ["Chaminade - Madonna College Preparatory",9,"Hollywood"],
...
export const SCHOOLS = SCHOOLS_RAW.map((row, idx) => {
  ...
  if (!coords) { _missing.push(city); return null; }
  const [lat, lng] = coords;
  const jLat = jitter(idx * 2,     0.025);
  const jLng = jitter(idx * 2 + 1, 0.025);
  const fLat = lat + jLat;
  const fLng = lng + jLng;
  const [x, y] = project(fLng, fLat);
  return { n: name, d: d, x: x, y: y, lat: fLat, lng: fLng, city: city };
}).filter(Boolean);
